...
class TestMain(unittest.TestCase):
    ...
    def test_successful_run(self, mock_makedirs, mock_logger, mock_load_config, mock_init_db, mock_start_scheduler):
    ...
    @patch('src.main.init_database')
    @patch('src.main.load_config')
    def test_db_init_failure(self, mock_load_config, mock_init_db, mock_logger):
        mock_load_config.return_value = {
            'db_path': 'data/monitor.db',
            'log_level': 'INFO',
            'interval': 60,
